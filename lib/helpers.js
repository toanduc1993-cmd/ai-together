export const STATUS_CONFIG = {
    ...
    planned: { label: "Kế hoạch", color: "#6366F1", bg: "#312E81" },
    in_progress: { label: "Đang thực hiện", color: "#F59E0B", bg: "#78350F" },
    in_review: { label: "Chờ duyệt", color: "#8B5CF6", bg: "#4C1D95" },
    changes_requested: { label: "Cần sửa", color: "#EF4444", bg: "#7F1D1D" },
    approved: { label: "Phê duyệt", color: "#10B981", bg: "#064E3B" },
    submitted: { label: "Đã nộp", color: "#3B82F6", bg: "#1E3A5F" },
};
